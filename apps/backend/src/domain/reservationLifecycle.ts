...
const PRE_WITH_RENTER_STATUS_SET = new Set<ReservationStatus>([
  "CART",
  "PENDING_PAYMENT",
  "PENDING_VENDOR_REVIEW",
  "AWAITING_SURCHARGE_PAYMENT",
...
export function isPreWithRenterStatus(status: ReservationStatus) {
  return PRE_WITH_RENTER_STATUS_SET.has(status);
}
