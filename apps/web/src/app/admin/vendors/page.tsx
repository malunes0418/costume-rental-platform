    ...
    <div className="p-6 md:p-10 space-y-8">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <div className="flex gap-2 p-1 border border-border bg-muted/30 rounded-xl">
          <button
            ...
            className={cn(
              "px-4 py-1.5 text-[10px] font-semibold uppercase tracking-widest rounded-xl transition-colors",
      ...
      {loading ? (
        ...
        pendingVendors.length === 0 ? (
          <div className="flex flex-col items-center gap-4 border border-border bg-card rounded-xl py-28 text-center">
              ...
              <div key={v.id} className="flex flex-col gap-4 px-6 py-5 sm:flex-row sm:items-center sm:justify-between transition-colors hover:bg-muted/30">
                ...
                <div className="flex items-center gap-2 shrink-0">
                  <button
                    ...
                    className="flex h-9 items-center gap-1.5 rounded-xl border border-emerald-400/40 px-4 text-[10px] font-semibold uppercase tracking-widest text-emerald-700 transition-colors hover:bg-emerald-50 dark:text-emerald-400 dark:hover:bg-emerald-900/20 disabled:opacity-40"
                  >
                  ...
                  <button
                    ...
                    className="flex h-9 items-center gap-1.5 rounded-xl border border-destructive/30 px-4 text-[10px] font-semibold uppercase tracking-widest text-destructive transition-colors hover:bg-destructive/10 disabled:opacity-40"
                  >
        ...
        allVendors.length === 0 ? (
          <div className="flex flex-col items-center gap-4 border border-border bg-card rounded-xl py-28 text-center">
            <p className="font-display text-3xl font-semibold text-foreground">No vendors yet.</p>
